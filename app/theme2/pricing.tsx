      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Select a plan tailored to your streaming needs with our full channel lineup.
          </p>
          ...
          {pricingPlans.map((plan) => (
            ...
            >
              ...
              <div className="flex flex-col flex-1 p-6">
                ...
                <Link
                  href={`${process.env.NEXT_PUBLIC_REDIRECT_TO}/checkout?plan=${plan.title.toLowerCase()}&billing=${billingPeriod}`}
