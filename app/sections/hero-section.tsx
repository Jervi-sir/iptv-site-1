            ...
            <div className="mx-auto max-w-7xl px-6">
              <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
                ...
                <TextEffect
                  ...
                  speedSegment={0.3}
                  as="h1"
                  className="mt-8 text-balance text-6xl md:text-7xl lg:mt-8 xl:text-[5.25rem]">
                  Unlock Endless Entertainment with Premium IPTV
                </TextEffect>
                <TextEffect
                  per="line"
                  preset="fade-in-blur"
                  ...
                  Stream thousands of live TV channels, movies, and shows in HD – anytime, anywhere, on any device.
                </TextEffect>
