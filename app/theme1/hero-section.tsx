...
import { HeroHeader } from '@/app/theme1/hero5-header'
    ...
    <main className="overflow-hidden">
      ...
      <section>
        <div className="relative pt-24 md:pt-28">
          <AnimatedGroup variants={{ container: { visible: { transition: { delayChildren: 1 } } }, item: { hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0, transition: { type: 'spring', bounce: 0.3, duration: 2 } } } }} className="absolute inset-0 -z-20">
            <Image src="/night-background.webp" alt="IPTV streaming on TV" className="absolute inset-x-0 top-56 -z-20 hidden lg:top-32 dark:block" width="3276" height="4095" />
          </AnimatedGroup>
          <div className="absolute inset-0 -z-10 size-full [background:radial-gradient(125%_125%_at_50%_100%,transparent_0%,var(--color-background)_75%)]"></div>
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
              <PricingBanner /> {/* Assumes banner shows "Limited Offer: 20% Off" */}
              <TextEffect preset="fade-in-blur" speedSegment={0.3} as="h1" className="mt-4 text-balance text-6xl md:text-7xl lg:mt-8 xl:text-[5.25rem]">
                Best IPTV Deal: 10,000+ Channels for $9/mo
              </TextEffect>
              <TextEffect per="line" preset="fade-in-blur" speedSegment={0.3} delay={0.5} as="p" className="mx-auto mt-8 max-w-2xl text-balance text-lg">
                Stream live TV, sports, movies, and global channels on any device, anytime, with no contracts.
              </TextEffect>
